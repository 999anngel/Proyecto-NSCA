...
@Component({
  selector: 'app-Accesorios-unisex',
  templateUrl: './Accesorios-unisex.page.html',
  styleUrls: ['./Accesorios-unisex.page.scss'],
})
export class AccesoriosUnisexPage implements OnInit {
